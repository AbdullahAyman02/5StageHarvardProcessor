...
ADDI R2,R2,FFFF   #R2= 00010018 (C = 0,N,Z= 0) OR R2=18 if implementing sign extend // carry is one
SWAP R2, R4  
...
CMP R1, R3        #(C = 1, N = 1, Z = 0) // carry is 0
ADD R6, R5, R5    # Overflow exception // check on carry (tele3 b wa7ed 3ndena), mafee4 overflow
